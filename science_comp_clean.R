...
# re-add reference links then save .csv file
references <- science_raw %>% 
  select(name, links)

science_complete <- left_join(science, references, by = "name")

write_csv(science_complete, path = "./science_comp.csv")